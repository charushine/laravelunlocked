    ...
    */
    ...
    //   dd($getData);
            ...
            try
            {
                ...
                if($create_status)
                {
                    $redirecturl = route('login', ['register']);
                    $response = ['success' => true,'message' => Config::get('constants.SUCCESS.ACCOUNT_CREATED'), 'message2' => $redirecturl];
                }
                else{
                    $response = ['success' => false,'message' => Config::get('constants.ERROR.OOPS_ERROR')];
                }
