						...
						<div class="row">
							<div class="col-lg-4 col-md-6 col-12">
								<div class="form-group">
									...
									<input type="file" name="venue_image_name[]" id="venue_image_name" placeholder="Venue Image" value="{{old('name' , isset($venueImages->name) ? $venueImages->name : '')}}"  class="form-control form-control-user" multiple/>
