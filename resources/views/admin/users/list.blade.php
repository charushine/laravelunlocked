				...
				<div class="card-header py-3">
					<form class="form-inline float-left" id="search-form">
						<div class="form-group">
							<input type="text" value="{{$keyword}}" class="form-control" data-model="User" data-searchcoulnm="first_name,last_name,email" id="search_keyword" name="search_keyword" placeholder="What are you looking for?">
						</div>
						...
						<table class="table table-hover dt-responsive nowrap">
							...
							<tbody>
								...
								<tr>
									...
									<td>
									@if($row->is_deleted == 1)
										<a title="Click to Recover" href="{{route('user.delete',['id' => $row->id, 'is_deleted' => 0])}}" class="tableLink"><i class="fas fa-toggle-off danger"></i></a>
									@else
									<a title="Click to Delete" href="{{route('user.delete',['id' => $row->id, 'is_deleted' => 1])}}" class="tableLink"><i class="fas fa-toggle-on success"></i></a>
									@endif
									</td>
									<td>
									<a class="anchorLess">
